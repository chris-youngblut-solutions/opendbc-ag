...
- **Reference CAN trace corpus** in `corpus/` is currently a placeholder directory. Trace capture requires hardware deployment and field operations — it lives outside the autonomous-build scope. See `RALPH_REPORT.md` for the hand-off.
